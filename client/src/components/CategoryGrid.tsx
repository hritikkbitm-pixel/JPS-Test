    ...
    return (
        <div className="mb-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {categories
                    .filter(cat => !['accessories', 'headset', 'webcam', 'gamepad', 'steering-wheel', 'gaming-accessories'].includes(cat.id))
                    .map((cat) => (
                        <div
                            key={cat.id}
                        ...
                        >
                            <img
                                src={cat.image || "https://via.placeholder.com/300?text=No+Category"}
                                alt={cat.label}
